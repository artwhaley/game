...
//				mat.SetTexture("_SpecGlossMap",glossyRoughessMap);
		...
		public Material ConvertToUnity(DTUMaterial dtuMaterial)
		{
			...
			if(materialType == DTUMaterialType.IrayUber)
			{
				...
				if(uberMat != null)
				{
					return SaveMaterialAsAsset(uberMat,materialPath);
				}
			} else if(materialType == DTUMaterialType.DazStudioDefault)
			{
				...
				if(defaultMat != null)
				{
					return SaveMaterialAsAsset(defaultMat,materialPath);
				}
			} else if(materialType == DTUMaterialType.PBRSP)
			{
				...
				if(pbrspMat != null)
				{
					return SaveMaterialAsAsset(pbrspMat,materialPath);
				}
			} else if(materialType == DTUMaterialType.OmUberSurface)
			{
				...
				if(localMat != null)
				{
					return SaveMaterialAsAsset(localMat,materialPath);
				}
		...
		public Material SaveMaterialAsAsset(Material mat, string materialPath)
		{
			if(mat == null)
			{
				return null;
